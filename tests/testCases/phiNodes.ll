...
entry:
  %call = tail call i64 @strlen(i8* %c4)
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load16 = load <4 x i8>, <4 x i8>* %3, align 1
...
entry:
  %call = tail call i32 @_Z8SomeFunci(i32 %i1)
  %cmp = icmp slt i32 %call, 0
  br i1 %cmp, label %cleanup, label %if.end

if.end:                                           ; preds = %entry
  %call1 = tail call i64 @strlen(i8* %c4)
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %2 = getelementptr i8, i8* %0, i64 4
  %3 = bitcast i8* %2 to <4 x i8>*
  %wide.load20 = load <4 x i8>, <4 x i8>* %3, align 1
  %4 = sext <4 x i8> %wide.load to <4 x i32>
